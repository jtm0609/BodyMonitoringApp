...
//verifyPhoneNumber()->onCodesent()->onVerificationCompleted()->signinWithPhoneAuthCredential()
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(AuthActivity.this, "로그인성공", Toast.LENGTH_SHORT).show();
                            ...
                            if(user_RadioBt.isChecked()){
                                ...
                                final Intent intent = new Intent(AuthActivity.this, UserServiceActivity.class);
                            ...
                            //보호자 라디오버튼이 눌려있다면
                                ...
                                sharedprefEdit.commit();
                                //UID조회
                                mDatabase.child("유저").child("보호자").addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        boolean flag=false;
                                        for(DataSnapshot data:dataSnapshot.getChildren()){
                        ...
                        //로그인 실패
                            ...
                            Toast.makeText(AuthActivity.this, "인증번호가틀립니다.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private static class MyHandler extends Handler{
        ...
        private final WeakReference<AuthActivity> mActivty;

        public MyHandler(AuthActivity activity){
            mActivty=new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(@NonNull Message msg) {
            AuthActivity activity = mActivty.get();
            if(activity!=null){
